    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-white via-blue-50 to-purple-50 pt-16">
          ...
          >
            ...
            >
              ...
              <div className="w-80 h-96 mx-auto relative">
                {/* Tube Body */}
                <div className="absolute inset-0 bg-gradient-to-b from-smiely-mint to-smiely-blueberry rounded-full transform rotate-12 shadow-2xl">
                  {/* Cap */}
                  ...
                  <div className="absolute top-8 left-1/2 transform -translate-x-1/2 -rotate-12 bg-white/90 backdrop-blur-sm px-6 py-3 rounded-full shadow-lg">
                    <span className="text-2xl font-bold text-smiely-mango">SMILEY</span>
                  </div>
      ...
      >
        <motion.div
          ...
          className="w-6 h-10 border-2 border-smiely-mango rounded-full flex justify-center"
        >
          <motion.div
            animate={{ y: [0, 12, 0] }}
            transition={{ duration: 2, repeat: Infinity }}
            className="w-1 h-3 bg-smiely-mango rounded-full mt-2"
          />
        </motion.div>
      </motion.div>
    </section>
